---
title: "How to retrieve cadastral parcels"
...
In the example below, Etalab and BDP geometries match perfectly.
```{r etalab_vs_bdp}
idus <- paste0("29158000AX0", 696:704)
...
tm_tiles("OpenStreetMap")+
tm_shape(etalab)+
  tm_borders(col = "firebrick", lwd = 10)+
tm_shape(bdp)+
  tm_borders(col = "springgreen", lwd = 2)
...
- Builds IDUs from matrix fields
