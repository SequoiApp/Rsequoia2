...
function expects a DRIAS projection \`.txt\` file located in the
\`4_METEO\` directory of the Sequoia project. It extracts metadata, raw
climatology, ombrothermic summaries, and evapotranspiration (ETP)
...
A named \`character\` vector: - \`"drias"\`: Path to the generated Excel
workbook

## Details

The function looks for a single \`.txt\` file in the \`4_METEO\`
directory. This file must be downloaded beforehand from the DRIAS portal
