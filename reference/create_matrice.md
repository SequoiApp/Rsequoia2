...
forest information (e.g., \`IDENTIFIANT\`, \`PROPRIETAIRE\`) and
cadastral attributes (\`CODE_INSEE\`, \`PREFIXE\`, \`SECTION\`,
\`NUMERO\`, \`LIEU_DIT\`).
...
- id:
  ...
  \`character\` Identifier of the forest. Typically the name of the
  forest
