...
polygons obtained with \[get_vege_poly()\].

GIS workflow : - Polygon are intersected to a 1500m buffer; - Polygon
are cast to \`LINESTRING\`; - Line are intersected with a 1500 buffer to
remove intersection line from first step
