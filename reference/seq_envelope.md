...
Generates convex hull polygons from an input \`sf\` object after
applying a buffer and union operation. The buffer step allows merging
nearby or disconnected geometries prior to computing the convex hull,
making the result more spatially coherent.
...
- crs:
  ...
  \`numeric\` or \`character\`; Target coordinate reference system used
