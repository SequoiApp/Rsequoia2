...
cadastral](https://sequoiapp.github.io/Rsequoia2/articles/02_cadastral-parcels-fr.html).
...
eckmuhl_matrice <- openxlsx2::read_xlsx(system.file("extdata/ECKMUHL_matrice.xlsx", package = "Rsequoia2"))
eckmuhl_sequoia_dir <- file.path(tempdir(), "ECKMUHL")
dir.create(eckmuhl_sequoia_dir)
openxlsx2::write_xlsx(eckmuhl_matrice, file.path(eckmuhl_sequoia_dir, "ECKMUHL_matrice.xlsx"))
...
#> ✔ _matrice.xlsx also saved as ECKMUHL_matrice_20260525T131013.xlsx for safety.
