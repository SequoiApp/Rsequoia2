...
#> ✔ Excel file created at: /tmp/Rtmp6nEpdG/MY_FOREST/MY_FOREST_matrice.xlsx
```
...
#> ℹ Downloading BDP from IGN...
#> ✔ 9 of 9 ETALAB geom successfully replaced with BDP geom.
#> ✔ Vector layer "v.seq.parca.poly" with 9 features saved to ECKMUHL_SEQ_PARCA_poly.geojson.
