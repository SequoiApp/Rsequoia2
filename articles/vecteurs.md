...
Les fonctions se déclinent en fonctions autonomes `get_*` (où `*`
correspont au thême de la couche) ou en fonctions intégrées au processus
formalisé de *Sequoia* `seq_*`.
