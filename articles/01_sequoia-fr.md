...
Il est recommandé de créer un répertoire dédié et de le définir comme
répertoire de travail de la session R.
...
- Données vectorielles (voir l’article sur le [téléchargement de données
  vectorielles](https://sequoiapp.github.io/Rsequoia2/articles/04_vector-fr.html))
  telle que :
...
- Données raster (voir l’article sur le [téléchargement de données
  raster](https://sequoiapp.github.io/Rsequoia2/articles/05_raster-fr.html))
...
données complémentaires, consiste à créer les unités d’analyse *UA*.
...
La couche *UA* doit alors être travailer sur un logiciel SIG pour
qu’elle reflète fidèlement la structure forestière réelle.

Ce travail est souvent réalisé en deux étapes : - Une
photo-interpétation ; - Une phase terrain pour préciser

Pour plus de détails, consultez l’article sur les [unités
d’analyse](https://sequoiapp.github.io/Rsequoia2/articles/06_analysis_units-fr.html)

#### Finalisation de la couche

Une fois que la couche *UA* est complétée, il est nécessaire de la
valider :
